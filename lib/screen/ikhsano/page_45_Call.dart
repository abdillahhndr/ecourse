...
import 'package:ecourse/screen/ikhsano/page_44_Chat.dart';
import 'package:ecourse/screen/ikhsano/page_46_CallVoice.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              buildCallsCard(
                profileImage: AssetImage('assets/profile/bwindow.png'),
              ...
              buildCallsCard(
                profileImage: AssetImage('assets/profile/iron.png'),
              ...
              SizedBox(height: 10), // Add spacing between cards
              buildCallsCard(
                profileImage: AssetImage('assets/profile/captain.png'),
                name: 'Roy M c',
                callTime: 'Yesterday, 21:07 PM',
                callDuration: '100 minutes',
              ),
      ...
      child: Padding(
        ...
        child: ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => PageCallsVoice()),
            );
          },
        ),
      ),
